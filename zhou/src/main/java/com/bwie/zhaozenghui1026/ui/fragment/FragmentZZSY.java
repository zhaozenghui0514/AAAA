 ...
 */
public class FragmentZZSY extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_fragment_zzsy, container, false);
        xListView = view.findViewById(R.id.xListView_zzsy);
    ...
    private void questData(int page) {
        String s = "http://172.17.8.100/movieApi/movie/v1/findReleaseMovieList?count=10&page="+page;
